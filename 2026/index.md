...
<details>
  <summary style="cursor: pointer;">
    <b>Root cause analysis using summary causal graph</b><br>
    Charles Assaad (Sorbonne Université Paris, Inserm)<br>
...
<details>
  <summary style="cursor: pointer;">
    <b>Feature Zero: Who Fired First? Model-Agnostic Root-Cause Localization in ICS: A Case Study</b><br>
    Jiyan Mahmud and Imre Lendák<br>
    <a><span class="label-closed">Show</span><span class="label-open">Hide</span> Details</a>
    <a class="icon-link" href="./assets/papers/421_Mahmud-et-al_Feature-Zero-Who-Fired-First-Model-Agnostic-Root-Cause-Localization-in-ICS-A-Case-Study.pdf" target="_blank"><i class="bi bi-file-earmark-pdf-fill"></i> Paper</a>
  </summary>
   <hr><span style="text-decoration: underline;">Abstract</span><p>
...
<details>
  <summary style="cursor: pointer;">
    <b>Segmentation for Gaussian Graphical Models on Wastewater Sensor Data</b><br>
    Ronan Timon, James McDermott and Vikrant Singh Jamwal<br>
    <a><span class="label-closed">Show</span><span class="label-open">Hide</span> Details</a>
    <a class="icon-link" href="./assets/papers/559_Timon-et-al_Segmentation-for-Gaussian-Graphical-Models-on-Wastewater-Sensor-Data.pdf" target="_blank"><i class="bi bi-file-earmark-pdf-fill"></i> Paper</a>
  </summary>
   <hr><span style="text-decoration: underline;">Abstract</span><p>
