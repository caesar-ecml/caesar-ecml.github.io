...
<details>
  <summary style="cursor: pointer;"><b>Root cause analysis using summary causal graph</b><br>Charles Assaad (Sorbonne Université Paris, Inserm)</summary>
...
<details>
  <summary style="cursor: pointer;"><b>Root cause analysis via difference graph discovery from linear time-series data</b><br>Anouk Ruer, Timothee Loranchet et al.</summary>
   <hr><span style="text-decoration: underline;">Abstract</span><p>
...
<details>
  <summary style="cursor: pointer;"><b>PRIM: Meta-Learned Bayesian Root Cause Analysis</b><br>Christopher Lohse, Anish Dhir et al.</summary>
   <hr><span style="text-decoration: underline;">Abstract</span><p>
...
<details>
  <summary style="cursor: pointer;"><b>Causal Characterization of Measurement and Mechanistic Anomalies</b><br>Hendrik Suhr, David Kaltenpoth and Jilles Vreeken</summary>
   <hr><span style="text-decoration: underline;">Abstract</span><p>
...
<tr><td>
<details>
  <summary style="cursor: pointer;"><b>Does Causally Informed Graphs Improve Domain Generalisation in Industrial Anomaly Detection</b><br>Supraja Muralidharan, Karthikey Sharma, et al.</summary>
   <hr><span style="text-decoration: underline;">Abstract</span><p>
...
<tr><td>
<details>
  <summary style="cursor: pointer;"><b>The JANUS Decision: Joint Adjudication via Negative-and-positive control Unified Signals for Observational Causal Inference</b><br>Raphael Derecki, Bogna Liziniewicz et al.</summary>
   <hr><span style="text-decoration: underline;">Abstract</span><p>
...
<details>
  <summary style="cursor: pointer;"><b>Localized Anomaly Detection via Differentiable D-vine Copula</b><br>Nicholas Pearson, Francesca Zanello et al.</summary>
   <hr><span style="text-decoration: underline;">Abstract</span><p>
...
<details>
  <summary style="cursor: pointer;"><b>Feature Zero: Who Fired First? Model-Agnostic Root-Cause Localization in ICS: A Case Study</b><br>Jiyan Mahmud and Imre Lendák</summary>
   <hr><span style="text-decoration: underline;">Abstract</span><p>
...
<details>
  <summary style="cursor: pointer;"><b>Segmentation for Gaussian Graphical Models on Wastewater Sensor Data</b><br>Ronan Timon, James McDermott and Vikrant Singh Jamwal</summary>
   <hr><span style="text-decoration: underline;">Abstract</span><p>
